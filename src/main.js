import './style.css';
const PROFILE = {"day":"Day031","title":"Inspect Lens Board 1","display_name_ja":"中身チェックツール","one_sentence":"見えにくい違いや中身を見つけやすくするためのツールです。","purpose_line_ja":"見えにくい違いや中身を見つけやすくするためのツールです。","use_case_line_ja":"ごちゃっとしていて何を見るか迷う時に使います。","how_it_works_line_ja":"気になる項目を入れると、見るべきポイントが出ます。","core_action":"inspect","family":"reveal_inspection","mechanic":"inspect","input_style":"tokens","output_style":"board","audience_promise":"pattern_discovery","publish_hook":"カードの組み合わせから次の試作案を素早く作るデッキ型ツール。（話題:GitHub Trending (A） を visual_demo 角度で見せる","engine":"brief_driven","interaction_archetype":"inspect","page_archetype":"inspector_grid","output_shape":"inspector_grid","state_model":"inspect_state","core_loop":"tokens -> inspect -> board","component_pack":"inspector_grid+board","scaffold_id":"card_deck_board","single_shot_text_generator":false};
